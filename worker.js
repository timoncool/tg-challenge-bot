...
Последний танец | Двое танцуют танго на краю пропасти. Метафора отношений, где каждое движение может быть последним. Страсть, контроль, доверие и падение.
  ...
  const nsfwPrompts = {
    daily: `<role>
Ты — арт-директор сообщества художников, создающих художественную эротику и ню-арт для аудитории 21+.
</role>

<task>
Придумай 6 тем для ЕЖЕДНЕВНОГО челленджа. Лёгкие темы на красивую, эстетичную эротику.
</task>
...
- Каждая тема состоит из ДВУХ частей через разделитель " | ":
  1. КОРОТКОЕ НАЗВАНИЕ (2-3 слова) — для голосования в опросе
  2. ПОЛНОЕ ОПИСАНИЕ (1 предложение) — для объявления челленджа
- Фокус на ЭСТЕТИКЕ и КРАСОТЕ человеческого тела
- Используй художественные термины: ню, фигуратив, силуэт, изгибы, пластика тела
- Вдохновляйся классическим искусством: Ренессанс, прерафаэлиты, Климт, Мухa
- Темы должны быть чувственными, но элегантными
- МОЖНО: романтика, соблазн, интимность, страсть, обнажённая натура
- Язык: русский
${previousThemesNote}
</requirements>
...
<examples>
Венера цифровая | Рождение Венеры в современной интерпретации — богиня выходит из экрана смартфона
Утренний свет | Фигура в лучах утреннего солнца — игра света и тени на изгибах тела
Шёлк и кожа | Контраст нежного шёлка и тёплой кожи — минимум ткани, максимум эстетики
Поцелуй Климта | Влюблённая пара в золотых орнаментах в стиле Густава Климта
Богиня воды | Обнажённая нимфа в объятиях водопада — капли на коже как жемчуг
Танец вуали | Танцовщица в движении — полупрозрачная ткань подчёркивает пластику тела
</examples>`,

    weekly: `<role>
Ты — арт-директор сообщества художников, создающих художественную эротику для аудитории 21+.
</role>

<task>
Придумай 6 тем для ЕЖЕНЕДЕЛЬНОГО челленджа. Темы средней сложности для создания красивого эротического арта.
</task>
...
- Каждая тема состоит из ДВУХ частей через разделитель " | ":
  1. КОРОТКОЕ НАЗВАНИЕ (2-3 слова) — для голосования в опросе
  2. ПОЛНОЕ ОПИСАНИЕ (1-2 предложения) — для объявления челленджа
- Используй художественную терминологию: фигуратив, пластика, композиция тел, чувственность
- Вдохновляйся историей искусства: Возрождение, Рококо, Ар-нуво, классическая скульптура
- МОЖНО: страсть, желание, интимность, соблазн, романтическое напряжение
- МОЖНО: отсылки к мифологии, литературе, кино (но в эротическом контексте)
- Язык: русский
${previousThemesNote}
</requirements>
...
<examples>
Сон фавна | Послеполуденный отдых мифологического создания в окружении нимф — томная нега и чувственность древних мифов
Будуар ведьмы | Интимный момент в комнате колдуньи — свечи, зелья, обнажённые плечи и опасная красота
Пара в грозу | Двое влюблённых под дождём — мокрая одежда, прилипшая к телам, молния освещает страсть
Японская весна | Эстетика сюнга — цветущая сакура, шёлковые кимоно соскальзывают с плеч
Тёмный соблазн | Инкуб или суккуб в момент обольщения — демоническая красота и земное желание
После бала | Маскарад окончен, маски сняты — усталость, шампанское и интимность на рассвете
</examples>`,
...
<task>
Придумай 6 тем для ЕЖЕМЕСЯЧНОГО челленджа. АМБИЦИОЗНЫЕ темы для создания произведений музейного уровня.
</task>
...
- Каждая тема состоит из ДВУХ частей через разделитель " | ":
  1. КОРОТКОЕ НАЗВАНИЕ (2-3 слова) — для голосования в опросе
  2. ПОЛНОЕ ОПИСАНИЕ (2-3 предложения) — для объявления челленджа
- Это должно быть ИСКУССТВО уровня музейных коллекций
- Вдохновение: великие художники, мифология, литературная эротика
- Темы должны исследовать: красоту тела, чувственность, желание, интимность, страсть
- Используй художественную терминологию: фигуративная композиция, пластика форм, чувственная эстетика
- Язык: русский
${previousThemesNote}
</requirements>
...
<examples>
Олимп интимный | Боги Древней Греции в моменты уединения и страсти. Зевс и его возлюбленные, купание Афродиты, объятия Ареса. Классическая красота и божественная чувственность.
Письма незнакомке | Визуализация эротической переписки XIX века. Что представляла женщина, читая откровенное письмо при свечах? Фантазия обретает форму.
Семь покровов | Танец Саломеи — семь стадий обнажения, семь состояний от невинности до страсти. Восточная эстетика, драпировки и пластика движения.
Эрос и Танатос | Связь любви и смерти в искусстве. Красота увядания, последний поцелуй, скелет обнимающий возлюбленную — как у Бёклина, но чувственнее.
Сны Анаис | Визуализация дневников Анаис Нин. Литературная эротика Парижа 1930-х — богемные вечера, запретные связи, чувственность в каждой строке.
Метаморфозы Овидия | Эротические превращения из мифов — Леда и лебедь, Даная и золотой дождь, Европа и бык. Момент между человеческим и божественным.
</examples>`,
  };
  ...
  const allFallbacks = {
    ...
    nsfw: {
      daily: [
        "Венера цифровая | Рождение Венеры в современной интерпретации — богиня красоты выходит из экрана смартфона, пиксели вместо пены морской",
        "Утренний свет | Обнажённая фигура в первых лучах утреннего солнца — нежная игра света и тени на изгибах тела, тёплые тона пробуждения",
        "Шёлк и кожа | Контраст нежного шёлка и тёплой человеческой кожи — минимум драпировки, максимум эстетики и чувственности",
        "Поцелуй Климта | Влюблённая пара в объятиях, окутанная золотыми орнаментами в стиле Густава Климта — страсть в каждом завитке",
        "Богиня воды | Обнажённая нимфа в нежных объятиях водопада — капли воды на коже как россыпь жемчуга, слияние с природой",
        "Танец вуали | Восточная танцовщица в движении — полупрозрачная ткань следует за телом, подчёркивая каждый изгиб и пластику",
      ],
      weekly: [
        "Сон фавна | Послеполуденный отдых мифологического создания в окружении лесных нимф — томная нега, чувственность древних мифов, золотой свет сквозь листву",
        "Будуар ведьмы | Интимный момент в комнате колдуньи при свечах — зелья, кристаллы, обнажённые плечи и опасная, притягательная красота",
        "Пара в грозу | Двое влюблённых под тёплым летним дождём — мокрая одежда, прилипшая к телам, молния освещает момент страсти",
        "Японская весна | Эстетика классической сюнга — цветущая сакура за окном, шёлковые кимоно медленно соскальзывают с плеч, интимность момента",
        "Тёмный соблазн | Инкуб или суккуб в момент обольщения — демоническая красота встречается с земным желанием, граница между опасностью и страстью",
        "После бала | Маскарад окончен, маски сняты — шампанское, усталость, рассвет за окном и интимность между теми, кто остался до утра",
      ],
      monthly: [
        "Олимп интимный | Боги Древней Греции в моменты страсти и уединения. Зевс и его возлюбленные, купание Афродиты, объятия Ареса и Афродиты. Классическая красота, божественная чувственность.",
        "Письма незнакомке | Визуализация эротической переписки XIX века. Что представляла женщина, читая откровенное письмо при свечах? Воображение обретает форму и плоть.",
        "Семь покровов | Танец Саломеи — семь стадий обнажения, семь состояний от невинности до страсти. Восточная эстетика, летящие драпировки, гипнотическая пластика движения.",
        "Эрос и Танатос | Вечная связь любви и смерти в искусстве. Красота увядания, последний поцелуй, скелет в нежных объятиях возлюбленной — как у Бёклина, но чувственнее.",
        "Сны Анаис | Визуализация эротических дневников Анаис Нин. Литературная чувственность Парижа 1930-х — богемные вечера, запретные связи, откровенность в каждой строке.",
        "Метаморфозы Овидия | Эротические превращения из античных мифов — Леда и лебедь, Даная и золотой дождь, Европа и бык. Момент трансформации между человеческим и божественным.",
      ],
    },
  };
