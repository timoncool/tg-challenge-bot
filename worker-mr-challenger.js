...
async function generateThemes(apiKey, type, language = "ru", previousThemes = [], contentMode = "vanilla") {
  ...
  const modeConfigs = {
    vanilla: {
      ...
      examples: `- "🌆 Уютная рамен-лавка поздней ночью, пар поднимается над тарелками. Тёплый свет бумажных фонариков отражается в мокром асфальте за окном."
- "🎭 Призрачная библиотека, где книги парят в воздухе между пыльными стеллажами. Свечи мерцают сами по себе, а готические тени танцуют на древних стенах."
- "💫 Взрослый человек обнимает себя-ребёнка в залитой солнцем гостиной из детства. Тёплые тона, эффект старой плёнки, пылинки в лучах света."
- "🎬 Кот в стимпанк-очках сидит на винтажном чемодане посреди аэродрома 1920-х. Вдали виднеются дирижабли, латунные механизмы поблёскивают на солнце."
- "🌸 Японский сад в момент цветения сакуры, лепестки кружат в воздухе. Старый мост через пруд с карпами, тишина и гармония."
- "🏔️ Одинокий домик на краю утёса над облаками, тёплый свет в окнах. Бескрайнее небо на закате, ощущение покоя и свободы."
- "🦊 Лиса в осеннем лесу среди золотых листьев, любопытный взгляд. Утренний туман между деревьями, грибы на поляне."
- "🌌 Маяк на краю вселенной, вокруг звёзды и туманности. Луч света пронзает космическую тьму, указывая путь кораблям."
- "☕ Букинистическая лавка в сумерках, янтарный свет сквозь пыльные окна. Стопки книг на старых столах, запах кофе и приключений."
- "🐉 Дракон свернулся вокруг горной вершины, охраняя древний храм. Облака плывут внизу, золотые чешуйки блестят на закате."
- "🎪 Город на спине гигантской черепахи, плывущей через океан. Маленькие домики, ветряные мельницы, жизнь в движении."
- "🌊 Подводный город русалок в лучах солнца, пробивающихся сквозь воду. Коралловые дворцы, танцующие медузы, мир без гравитации."
- "🎨 Художник рисует закат, но краски оживают и танцуют вокруг. Кисти летают сами, холст становится порталом в другой мир."
- "🌙 Ночной рынок в волшебном городе, фонари из светлячков. Торговцы продают звёздную пыль и разлитый лунный свет."
- "🏰 Замок из облаков, где живут хранители снов. Лестницы из радуги, комнаты меняют форму по желанию."
- "🎻 Призрак музыканта играет на скрипке в заброшенном театре. Пустые кресла, пыльный бархат, музыка, которую слышат только кошки."`,
    },
    medium: {
      desc: "Контент 16+. РАЗНООБРАЗИЕ: нуар, романтика, триллер, чёрный юмор, меланхолия, хоррор. НЕЛЬЗЯ: откровенная эротика.",
      examples: `- "🖤 Ведьма варит зелье в лесной хижине, зелёный дым клубится над котлом. Банки с ингредиентами на полках, чёрный кот внимательно наблюдает из угла."
- "🔪 Детектив в прокуренном кабинете изучает фото с места преступления. Дождь барабанит по окну, виски в стакане отражает свет лампы."
- "💀 Заброшенная психиатрическая больница, лунный свет сквозь разбитые окна. Ржавые каталки в коридоре, эхо шагов, которых нет."
- "🌹 Роковая женщина в красном платье у барной стойки, сигаретный дым вьётся вокруг. Опасный взгляд, алые губы, чужие секреты."
- "🎪 Заброшенный цирк ночью, карусель медленно вращается сама по себе. Потрёпанные клоунские костюмы висят в гримёрке, чей-то смех вдалеке."
- "⚰️ Викторианские похороны в дождь, чёрные зонты и вуали. Кто-то в толпе улыбается, зная правду о смерти."
- "🗡️ Дуэль на шпагах при свечах в заброшенном особняке. Тени танцуют на стенах, кровь на белой рубашке, дело чести."
- "🌑 Ритуал в лесу под полной луной, фигуры в капюшонах вокруг костра. Древние символы на земле, что-то пробуждается."
- "🚬 Подпольный покерный клуб 1920-х, дым сигар и блеск золота. Один игрок прячет туз в рукаве, другой — пистолет под столом."
- "🦇 Вампирский бал в готическом замке, все гости в масках. Кровь в хрустальных бокалах, танец, который длится вечность."
- "🎭 Актриса немого кино плачет в гримёрке, размазывая чёрную тушь. За дверью аплодисменты, но она знает — это её последний фильм."
- "🌧️ Одинокая фигура на мосту в 3 часа ночи, дождь и неоновые отражения. Письмо в кармане, решение ещё не принято."
- "🔮 Гадалка раскладывает карты Таро, клиент бледнеет. Смерть, Башня, Повешенный — три карты, одна судьба."
- "🏚️ Дом с привидениями выставлен на продажу, риелтор не понимает почему. Зеркала показывают прошлых жильцов, все они погибли здесь."
- "💉 Подпольный хирург зашивает рану бандита в грязной квартире. Водка вместо наркоза, долг вместо денег."
- "🎹 Пианист играет в пустом баре для призрака любимой женщины. Она умерла год назад, но каждую ночь садится рядом."`,
    },
    nsfw: {
      ...
      examples: `- "🔥 Страстный секс на офисном столе, разбросанные документы, она сверху. Его руки на её бёдрах, оба на грани оргазма."
- "⛓️ Связанная девушка с повязкой на глазах, ожидание прикосновения. Красные следы от верёвок на коже, капли воска на животе."
- "🛁 Минет в душе, вода стекает по телам, пар и страсть. Её колени на мокром кафеле, его пальцы в её волосах."
- "👙 Стриптизёрша на шесте, идеальное тело блестит от масла. Медленно снимает бикини, взгляд полный обещаний."
- "🌙 Секс втроём на огромной кровати, переплетение тел и стонов. Две девушки и парень, никаких границ и табу."
- "💋 Лесбийский секс с игрушками, одна кончает, другая смотрит с голодом. Мокрые тела, страпон, полная отдача удовольствию."
- "🍑 Анальный секс в позе догги-стайл, её стоны и его хватка на бёдрах. Зеркало напротив отражает их лица в экстазе."
- "👅 Куннилингус на кухонном столе, её ноги на его плечах. Фрукты и вино рядом, ленивое воскресное утро переходит в страсть."
- "🎭 Секс в масках на венецианском карнавале, анонимность разжигает желание. Роскошные костюмы падают на пол, тела сплетаются в танце."
- "📸 Откровенная фотосессия, модель мастурбирует перед камерой. Профессиональный свет, любительская страсть, грань между искусством и порно."
- "🏨 Измена в дорогом отеле, торопливый секс пока муж на совещании. Скомканные простыни, туфли у двери, смс 'скоро буду'."
- "👠 Госпожа в латексе и на шпильках, раб целует её сапоги. Плётка на стене, ошейник на нём, полный контроль."
- "🎰 Секс за проигранное пари, она платит телом. Казино, приватная комната, свидетели делают ставки."
- "🚿 Случайный секс в раздевалке спортзала, вспотевшие тела. Её ноги вокруг его талии, его рука зажимает ей рот."
- "🌺 Тантрический секс при свечах, медленные движения, полная осознанность. Глаза в глаза, дыхание синхронно, оргазм как медитация."
- "🎬 Съёмки порно, актриса стонет на камеру, режиссёр командует. Грим, свет, дубль 15 — но страсть настоящая."
- "💍 Секс молодожёнов в лимузине по дороге с венчания. Она в фате, он расстёгивает ширинку, водитель не смотрит."
- "🏖️ Секс на нудистском пляже, волны лижут тела. Солнце, песок везде, случайные зрители возбуждают ещё больше."
- "🍷 Оргия в особняке миллиардера, десятки обнажённых тел. Бассейн, шампанское, любые комбинации и желания."
- "👩‍⚕️ Ролевая игра врач-пациентка, осмотр переходит границы. Латексные перчатки, стетоскоп, 'вам нужен особый массаж'."`,
    },
  };
...
${formatChallenge(monthly, "Месячный")}`;
    ...
    if (command === "/test_ai" && isAdmin) {
      await tg.sendHtml(chatId, "🔄 <i>Проверяю связь с Gemini...</i>", { message_thread_id: threadId || undefined });
      try {
        ...
        let msg = `✅ <b>Gemini работает</b> (режим: <i>${contentMode}</i>)\n\n`;
