...
1. 🎨 ТРЕНДЫ 2025
   "Создайте утопический городской пейзаж Solarpunk, где стеклянные небоскрёбы увиты вертикальными садами и залиты тёплым закатным светом."
   "Визуализируйте 3D-персонажа в стиле Blind Box из матового пластика, используя мягкие пастельные тона и дутую геометрию."
   "Создайте композицию Frutiger Aero: прозрачный стеклянный глобус с водой и рыбами на фоне сочного зелёного луга."

2. 🌆 АТМОСФЕРА
   "Визуализируйте бесконечный пустой бассейн с белой плиткой как лиминальное пространство, вызывающее чувство тревоги и сновидческой ностальгии."
   "Создайте сцену встречи двух силуэтов под неоновой вывеской в дождливом переулке, используя высокий контраст и объёмный туман."
   "Стилизуйте ночную съёмку улицы под запись с видеокассеты 90-х, добавив цветовой шум, полосы трекинга и дату в углу экрана."

3. 🎭 СЮРРЕАЛИЗМ
   "Создайте библиотеку внутри гигантских песочных часов, где книги медленно засыпает песком времени."
   "Изобразите город на спине спящего кита, плывущего сквозь розовые облака на закате."
   "Визуализируйте комнату, где гравитация работает в разные стороны — мебель на потолке, люди на стенах."

4. 💫 ЭМОЦИЯ/КОНЦЕПТ
   "Создайте сцену, где взрослый человек обнимает себя-ребёнка в залитой солнцем комнате из детства."
   "Скомпонуйте кадр, разложив содержимое рюкзака путешественника строго под углом 90 градусов, передавая эстетику организованного хаоса."
   "Изобразите тревожную сцену на залитой солнцем цветочной поляне, где яркий свет контрастирует с мрачным подтекстом."

5. 🎬 ЭСТЕТИКА (без персонажей!)
   "Создайте ночную гонку в неоновом городе 80-х в стиле Synthwave: хромированные машины, пальмы, закатное солнце на горизонте."
   "Изобразите руины забытого храма в эстетике Dark Souls: туман, угасающий свет, ощущение древней угрозы."
   "Создайте летний день в деревне в атмосфере Studio Ghibli: пушистые облака, зелёные холмы, велосипед у забора."

6. ✨ ТЕХНИКА/СТИЛЬ
   "Создайте симметричную иллюстрацию лесного духа в стиле элементального фолка, имитируя грубую текстуру линогравюры."
   "Изобразите футуристический рейв Y2K Cybercore, добавив хромированную одежду, тонированные очки и неоновое свечение."
   "Создайте японскую гравюру укиё-э, но действие происходит в открытом космосе среди звёзд и туманностей."

ФОРМАТ ТЕМЫ: 1-2 вдохновляющих предложения
