...
async function generateThemes(apiKey, type, language = "ru", previousThemes = [], contentMode = "vanilla") {
  ...
  const vanillaPrompts = {
    daily: `<role>
Ты — креативный директор сообщества нейро-художников (2000+ участников).
</role>

<task>
Придумай 6 тем для ЕЖЕДНЕВНОГО челленджа. Лёгкие, весёлые темы на 5-15 минут генерации.
</task>

<requirements>
- Каждая тема — 1-2 коротких предложения, которые полностью описывают идею
- Тема должна вдохновлять на ВИЗУАЛЬНЫЙ образ
- ОБЯЗАТЕЛЬНО включай отсылки к: фильмам, сериалам, аниме, играм, мемам, поп-культуре
- Разнообразие: реализм, фэнтези, юмор, sci-fi, природа, киберпанк, аниме, Marvel/DC
...
<format>
Выведи ТОЛЬКО 6 тем, каждая на новой строке.
Каждая тема — 1-2 предложения, НЕ больше.
НЕ используй markdown, таблицы или форматирование.
</format>

<examples>
НЕ КОПИРУЙ примеры! Придумай НОВЫЕ темы.

Дарт Вейдер готовит романтический ужин в фартуке "Лучший повар Галактики"
Пикачу ведёт лекцию по электродинамике в профессорских очках
Шрек открыл уютную кофейню на своём болоте, Осёл работает бариста
</examples>`,
...
<task>
Придумай 6 тем для ЕЖЕНЕДЕЛЬНОГО челленджа. Темы средней сложности, требующие экспериментов со стилями.
</task>

<requirements>
- Каждая тема — 1-2 предложения, которые полностью описывают идею
- ОБЯЗАТЕЛЬНО включай отсылки к: культовым фильмам, аниме, играм, сериалам
- Мэшапы и кроссоверы приветствуются: смешивай вселенные и жанры
- Разнообразие: сюжетные, атмосферные, стилизованные темы
- Избегай: политики, религии, насилия, эротики
- Язык: русский
${previousThemesNote}
</requirements>
...
Геральт расследует проклятие в неоновом киберпанк-Токио, серебряный меч против корпоративных духов
Мордор превратился в фабрику боевых дроидов, Око Саурона как голограмма над Звездой Смерти
Мир Пандоры в стиле Studio Ghibli — мягкие тона и добрые духи леса
</examples>`,
...
<task>
Придумай 6 тем для ЕЖЕМЕСЯЧНОГО челленджа. ЭПИЧЕСКИЕ темы — масштабные, зрелищные, достойные портфолио!
</task>

<requirements>
- Каждая тема — 1-2 предложения, которые полностью описывают эпическую идею
- Темы должны быть ЭПИЧЕСКИМИ и КОНКРЕТНЫМИ:
  * Культовые персонажи в неожиданных стилях (киберпанк, Ренессанс, советский плакат)
  * Эпические "что если" сценарии
  * Мэшапы эпох и стилей
  * Грандиозные финальные битвы, легендарные моменты
- ОБЯЗАТЕЛЬНО используй персонажей из: Marvel, DC, аниме, Disney/Pixar, игр, фильмов
- Это вызов мастерству: сложные композиции, wow-эффект
- Избегай: политики, религии, насилия, эротики
- Язык: русский
${previousThemesNote}
</requirements>
...
Тони Старк строит первый костюм в стиле советского конструктивизма — плакатная эстетика и arc-реактор в форме звезды
Все 151 покемон первого поколения на выпускном фото, Пикачу в центре, Слоупок опаздывает
Финальная битва Наруто и Саске в стиле японской гравюры укиё-э с волнами Хокусая
</examples>`,
  };
  ...
  const mediumPrompts = {
    daily: `<role>
Ты — креативный директор сообщества нейро-художников. Аудитория — взрослые 16+.
</role>

<task>
Придумай 6 тем для ЕЖЕДНЕВНОГО челленджа. Лёгкие темы для взрослой аудитории.
</task>

<requirements>
- Каждая тема — 1-2 предложения, которые полностью описывают идею
- РАЗНООБРАЗИЕ настроений: романтика, драма, нуар, чёрный юмор, страсть, меланхолия, триллер
- НЕ ТОЛЬКО мрачное! Добавляй: красивое, страстное, ироничное, ностальгическое
- МОЖНО: романтика, напряжение между персонажами, роковые красавицы/красавцы
- МОЖНО: готика, нуар, хоррор-эстетика (но не ТОЛЬКО это!)
- ОБЯЗАТЕЛЬНО: отсылки к культовым фильмам, играм, аниме
...
<examples>
НЕ КОПИРУЙ! Придумай НОВЫЕ темы с разным настроением.

Роковая красотка в дымном баре 40-х ждёт свою жертву
Вампир заводит Tinder-профиль: интересы — готика и прогулки по кладбищам
Два соперника смотрят друг на друга через бокалы шампанского на светском приёме
</examples>`,

    weekly: `<role>
Ты — креативный директор сообщества нейро-художников. Аудитория 16+.
</role>
...
<requirements>
- Каждая тема — 1-2 предложения, которые полностью описывают идею
- РАЗНООБРАЗИЕ: нуар, романтика, триллер, меланхолия, страсть, ирония, ностальгия
- НЕ ЗАЦИКЛИВАЙСЯ на мрачном! Миксуй настроения
- МОЖНО: роковые персонажи, напряжённые сцены, красивое зло, драматичная любовь
- ПРИВЕТСТВУЮТСЯ: отсылки к культовым R-rated фильмам, взрослым аниме, играм
...
<examples>
НЕ КОПИРУЙ! Придумай НОВЫЕ темы.

Тайлер Дёрден открывает арт-клуб — первое правило: не говорить о клубе
Ангелы устроили вечеринку в казино Вегаса, неоновые нимбы мигают как вывески
Последний танец двух влюблённых на крыше под дождём перед расставанием навсегда
</examples>`,
...
<task>
Придумай 6 тем для ЕЖЕМЕСЯЧНОГО челленджа. ЭПИЧЕСКИЕ темы для взрослой аудитории!
</task>

<requirements>
- Каждая тема — 1-2 предложения, которые полностью описывают эпическую идею
- РАЗНООБРАЗИЕ настроений и стилей:
  * Злодеи и антигерои (Джокер, Веном, леди Димитреску)
  * Романтика и страсть — эпические любовные истории
  * Нуар и триллер — атмосферные сцены
  * Меланхолия и красота — грустное, но прекрасное
  * Ирония и чёрный юмор
- НЕ ТОЛЬКО мрачное! Красота, драма, страсть — тоже для взрослых
- ОБЯЗАТЕЛЬНО: персонажи из хорроров, нуар-фильмов, аниме, игр
...
Леди Димитреску устраивает бал для всех вампиров кинематографа — Дракула, Лестат, Селена
Готэм в стиле картин Хоппера — Бэтмен как одинокий силуэт в ночной забегаловке
Два бывших врага встретились через 20 лет и поняли, что любили друг друга всё это время
</examples>`,
  };
  ...
  const nsfwPrompts = {
    daily: `<role>
Ты — арт-директор сообщества художников, создающих художественную эротику для 21+.
</role>
...
<requirements>
- Каждая тема — 1-2 предложения, которые полностью описывают образ
- Фокус на ЭСТЕТИКЕ, СОБЛАЗНЕ и красоте
- МОЖНО: ролевые образы, фетиш-эстетика, соблазн, флирт
...
Соблазнительная медсестра в коротком халатике готовится к ночному дежурству
Красотка-механик в обтягивающем комбинезоне чинит ретро-автомобиль в стиле pin-up
Строгая секретарша в очках остаётся в офисе после всех
</examples>`,

    weekly: `<role>
Ты — арт-директор сообщества художников, создающих эротический арт для 21+.
</role>
...
<requirements>
- Каждая тема — 1-2 предложения, которые полностью описывают идею
- Сочетай классику и современность
- МОЖНО: униформа, лёгкий BDSM, фетиш-эстетика, эротические сцены из кино/аниме/игр
- НЕЛЬЗЯ: политика, религия, жестокость
- Язык: русский
${previousThemesNote}
</requirements>
...
Фавн отдыхает в окружении нимф — томная атмосфера древнегреческих мифов
Элегантная доминатрикс в корсете на троне, слуга у её ног с ошейником
Секретаршу застали за непристойным занятием в кабинете босса
</examples>`,
...
<task>
Придумай 6 тем для ЕЖЕМЕСЯЧНОГО челленджа. ЭПИЧЕСКИЕ эротические концепции!
</task>

<requirements>
- Каждая тема — 1-2 предложения, которые полностью описывают эпическую идею
- Темы должны быть ЭПИЧЕСКИМИ и КОНКРЕТНЫМИ:
  * Эротические версии культовых персонажей
  * Масштабные фантазии, мифология, фэнтези
  * Конкретные фетиши в эпическом исполнении
- ОБЯЗАТЕЛЬНО: конкретные персонажи и сеттинги
- НЕЛЬЗЯ: политика, религия, жестокость
- Язык: русский
${previousThemesNote}
</requirements>
...
Тифа и Аэрис устроили совместную откровенную фотосессию в стиле 90-х журналов
Леди Димитреску принимает ванну в готическом замке, дочери-вампирши прислуживают
Ежегодный бал суккубов и инкубов в адском дворце — элегантный разврат преисподней
</examples>`,
  };
