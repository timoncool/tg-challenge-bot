...
ОБЯЗАТЕЛЬНО 6 РАЗНЫХ КАТЕГОРИЙ (по одной теме из каждой):

1. 🌆 АТМОСФЕРА - место + настроение + время
   Примеры: "Заброшенный неоновый город после дождя", "Уютная кофейня в снежную полночь", "Пустынный пляж на закате с одиноким маяком"

2. 🎭 СЮРРЕАЛИЗМ - неожиданные сочетания, невозможное
   Примеры: "Киты, плывущие в облаках над мегаполисом", "Библиотека внутри гигантских часов", "Лес из светящихся грибов под звёздным небом"

3. 🎬 ПОП-КУЛЬТУРА - отсылки к фильмам, играм, аниме, музыке (но БЕЗ конкретных персонажей!)
   Примеры: "Эстетика киберпанка 2077", "Атмосфера студии Ghibli", "Визуальный стиль Blade Runner", "Мир в духе Dark Souls"

4. 💫 ЭМОЦИЯ/СОСТОЯНИЕ - чувство через образ
   Примеры: "Тишина перед бурей", "Ностальгия по детству", "Момент озарения", "Сладкая меланхолия осени"

5. 🎨 СТИЛЬ/ТЕХНИКА - художественный эксперимент
   Примеры: "Арт-деко встречает киберпанк", "Акварельный апокалипсис", "Ренессанс в неоновых тонах", "Пиксель-арт фэнтези"

6. ✨ ПРОСТАЯ КРАСОТА - минималистичная, но цепляющая
   Примеры: "Капля росы на паутине", "Старая книга у камина", "Кот на подоконнике в дождь", "Закат в горах"

ПРАВИЛА:
- Каждая тема 1-2 предложения
- Вдохновляй, но оставляй свободу интерпретации
- Используй эмодзи и HTML (<b>акцент</b>, <i>нюанс</i>) уместно
- МИКС сложности: 2 простых, 2 средних, 2 амбициозных

ЗАПРЕЩЕНО:
- "Персонаж X как Y" / "X в стиле Y" - БАНАЛЬНО
- Конкретные имена персонажей (Наруто, Геральт и т.д.)
- Слишком абстрактно без визуального образа
- 6 одинаковых по духу тем

${modeDesc}${previousThemesNote}

JSON массив ровно из 6 строк:
