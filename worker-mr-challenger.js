...
ЛОГИКА СОЗДАНИЯ:
1. ПОП-КУЛЬТУРА: Используй ярких персонажей и ставь их в необычные условия.
2. МЭШАПЫ: Смешивай стили и миры (напр. киберпанк + гжель, викторианский sci-fi, гендер-бендер версии).
3. ВИЗУАЛ: Делай акцент на текстурах (неон, вода, мех, золото, ржавчина, шелк, татуировки).
4. СИТУАЦИИ: Моменты с интригой (шантаж, неловкое знакомство, трансформация, только проснулась).
5. ФОРМАТ: Темы должны быть короткими, хлёсткими и визуально понятными. Никакой воды.

БАЗА ПРИМЕРОВ (стиль, наглость, длина):
${selectedCorpus.join(", ")}
${history}
