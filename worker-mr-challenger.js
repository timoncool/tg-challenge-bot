...
async function generateThemes(apiKey, type, language = "ru", previousThemes = [], contentMode = "vanilla") {
  ...
  const modeDescriptions = {
    ...
    medium: "Контент 16+. РАЗНООБРАЗИЕ жанров: нуар, романтика, триллер, чёрный юмор, меланхолия, хоррор-эстетика. НЕЛЬЗЯ: откровенная эротика, политика, религия.",
    nsfw: "ЭРОТИЧЕСКИЙ АРТ 21+. Сексуальный, соблазнительный, провокационный контент. Обнажение, интимные сцены, фетиши, БДСМ-эстетика - ВСЁ МОЖНО. Фокус на эротизме и желании. НЕЛЬЗЯ: политика, религия, насилие без согласия.",
  };
  const modeDesc = modeDescriptions[contentMode] || modeDescriptions.vanilla;

  const prompt = `Придумай 6 РАЗНЫХ тем для ${typeName} нейро-арт челленджа.

ПО ОДНОЙ ТЕМЕ ИЗ КАЖДОЙ КАТЕГОРИИ:

1. 🌆 АТМОСФЕРА И МЕСТО
   "Уютная рамен-лавка ночью — пар поднимается над тарелками, тёплый свет бумажных фонариков отражается в мокром асфальте."
   "Букинистическая лавка в сумерках — янтарный свет сквозь пыльные окна, стопки книг на старых деревянных столах."
   "Прибрежные скалы в золотой час — мягкая дымка, чёткие травы на переднем плане, бесконечный горизонт."
   "Заброшенный торговый центр 90-х — лиминальное пространство, тревожная ностальгия, гулкая пустота."

2. 🎭 СЮРРЕАЛИЗМ И ФЭНТЕЗИ
   "Призрачная библиотека — книги парят в воздухе, свечи мерцают, готические тени танцуют на стенах."
   "Город на спине спящего кита, плывущего сквозь розовые облака на закате."
   "Гигантская рыба плывёт по улицам затопленного мегаполиса — люди смотрят из окон небоскрёбов."
   "Тающие часы на ветвях мёртвого дерева в потустороннем лесу."

3. 💫 ЭМОЦИЯ И ИСТОРИЯ
   "Взрослый обнимает себя-ребёнка в залитой солнцем гостиной из детства — тёплые тона, эффект старой плёнки."
   "Тайное свидание под древней ивой в лунном свете — два силуэта, мерцающие светлячки вокруг."
   "Одинокий путник на вокзале смотрит вслед уходящему поезду — дождь, неоновые отражения, меланхолия."
   "Феникс восстаёт из пепла — огненное оперение пылает оттенками заката на фоне звёздного неба."

4. 🎬 ЭСТЕТИКА И СТИЛЬ
   "Панда в киберпанк-переулке — неоновые отражения на солнцезащитных очках, голубое и фуксия свечение."
   "Кот-авиатор в стимпанк-очках сидит на винтажном чемодане посреди аэродрома 1920-х."
   "Уютный дом хоббита — потрескивающий камин, деревянные балки, тёплый свет сквозь круглые окна."
   "Synthwave-закат над ретро-городом — хромированные машины, пальмы, неоновая сетка на горизонте."

5. 🖤 ТЁМНОЕ И МИСТИЧЕСКОЕ
   "Ворон на человеческом черепе в лунном свете — готическая тишина, мерцание в пустых глазницах."
   "Демоническая сущность на железном троне в кольце пламени — витые рога, адское свечение снизу."
   "Ведьма варит зелье в лесной хижине — зелёный дым, банки с ингредиентами, чёрный кот наблюдает."
   "Заброшенный маяк в шторм — молнии освещают силуэт, волны разбиваются о скалы."

6. ✨ ПРОСТОЕ И КРАСИВОЕ
   "Капля росы на паутине — радужные переливы в утреннем свете, размытый лес на фоне."
   "Пушистый кот свернулся на подоконнике — за окном дождь, внутри тепло и уют."
   "Чашка кофе с паром на столе у окна — золотой утренний свет, раскрытая книга рядом."
   "Одинокое дерево посреди золотого пшеничного поля — закатное небо в пурпурных тонах."

ФОРМАТ: 1-2 предложения, создающих яркий образ
МИКС: 2 простых + 2 средних + 2 амбициозных
Эмодзи и <b>HTML</b> по желанию

ЗАПРЕЩЕНО: имена персонажей, "X как Y", 6 похожих тем

${modeDesc}${previousThemesNote}

JSON: ["тема1", "тема2", "тема3", "тема4", "тема5", "тема6"]`;
